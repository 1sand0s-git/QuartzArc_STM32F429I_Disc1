...
private:
	...
	GPIO_TypeDef*        m_pGPIO;       //Stores the GPIO port of the current output pin. A member of GPIO_TypeDef as defined in stm32f407xx.h
	uint16_t             m_uPin;        //Stores the pin number of the current output pin. A member of GPIO_pins_define as defined in stm32f4xx_hal_gpio.h
...
protected:
	...
	GPIO_TypeDef*     m_pGPIO;      //Stores the GPIO port of the current input pin. A member of GPIO_TypeDef as defined in stm32f407xx.h
	uint16_t          m_uPin;       //Stores the pin number of the current input pin. A member of GPIO_pins_define as defined in stm32f4xx_hal_gpio.h
