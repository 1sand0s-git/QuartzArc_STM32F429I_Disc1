...
QAD_TimerMgr::QAD_TimerMgr() {
  ...
  m_sTimers[QAD_Timer14].eTimer = QAD_Timer14;
	...
	//Set ADCs
	m_sTimers[QAD_Timer1].bADC  = false;
	m_sTimers[QAD_Timer2].bADC  = true;
	m_sTimers[QAD_Timer3].bADC  = true;
	m_sTimers[QAD_Timer4].bADC  = false;
	m_sTimers[QAD_Timer5].bADC  = false;
	m_sTimers[QAD_Timer6].bADC  = false;
